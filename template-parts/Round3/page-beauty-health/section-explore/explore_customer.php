<section id="explore__customer">
	<?php
		$titlePc = get_field('title_explore_beau');
		$titleMb = get_field('title_explore_mb_beau');
		$explore_beau = get_field('explore_beau');
	?>
<div class="container">
	<h2 class="headline">
	...
	<div class="explore__content">
		...
		?>
			<div class="explore__content__item <?= $active ?>">
				...
				<?php endif; ?>
				<div class="content">
					<?= wp_get_attachment_image(31980,'full',false) ?>
